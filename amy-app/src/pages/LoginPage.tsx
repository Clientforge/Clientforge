...
export function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-page-gradient p-6 dark:bg-page-gradient-dark">
      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="font-display text-3xl font-bold text-brand-800 dark:text-brand-300">AMY</h1>
          <p className="mt-2 text-sm text-stone-500 dark:text-stone-400">Sign in to access client records</p>
        </div>
