    ...
    <div className="automation-split-view">
      <div className="automation-list-pane">
        ...
        {loading ? (
          ...
          <div className="empty-state card"><p>No appointments yet</p><p className="muted">Appointments from Calendly or forwarded booking emails will appear here.</p></div>
        ) : (
          <>
