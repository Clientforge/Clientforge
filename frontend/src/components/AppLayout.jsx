...
function NavItems({ onNavigate }) {
  ...
  return (
    <>
      ...
      <NavLink to="/conversations" onClick={close} className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
      ...
      <NavLink to="/leads" onClick={close} className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
      ...
      <NavLink to="/contacts" onClick={close} className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
      ...
      <NavLink to="/campaigns" onClick={close} className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
      ...
      <NavLink to="/automations" onClick={close} className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" stroke="currentColor" strokeWidth="2" strokeLinecap="round" /><circle cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="2" /></svg>
        Automations
      </NavLink>
      <NavLink to="/settings" onClick={close} className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
  ...
  return (
    <div className={`app-layout${navOpen ? ' nav-open' : ''}`}>
      <header className="mobile-app-header">
        ...
        <span className="mobile-app-title">ClientForge<span className="brand-ai">.ai</span></span>
      </header>
