...
export const MedSpaScene5: React.FC = () => {
  ...
  return (
    <SceneTransition transitionFrames={25} type="slide-up">
      ...
      >
        ...
        >
          <Img
            src={staticFile('medspa-assets/6.png')}
            style={{ width: 480, height: 480, objectFit: 'contain' }}
          />
        </div>
        <div style={{ flex: 1, maxWidth: 420, opacity: textOpacity }}>
          <h1
            style={{
              fontSize: 54,
              fontWeight: 800,
          ...
          >
            Modern website • SMS reminders • Automated follow-ups
          </p>
        </div>
      </div>
    </SceneTransition>
