...
export default function HomePage() {
  ...
  return (
    <div className="g2g-home">
      <section className="g2g-hero g2g-hero--marketing" aria-labelledby="hero-heading">
        ...
        <div className="g2g-hero-actions">
          <Link to="/offer" className="g2g-btn g2g-btn--primary">
            {HERO.primaryCta}
          </Link>
          <Link to={HERO.secondaryTo} className="g2g-btn g2g-btn--ghost">
            {HERO.secondaryCta}
          </Link>
        </div>
      ...
      <section className="g2g-section g2g-cta-band" aria-labelledby="cta-mid-1">
        <h2 id="cta-mid-1" className="g2g-section-heading g2g-visually-hidden">
          Get started
        </h2>
      ...
      <section className="g2g-section g2g-cta-band g2g-cta-band--compact" aria-labelledby="cta-mid-2">
        <h2 id="cta-mid-2" className="g2g-visually-hidden">
          Get offer
        </h2>
      ...
      <aside className="g2g-sticky-cta" aria-label="Get offer">
        <Link to="/offer" className="g2g-btn g2g-btn--primary g2g-sticky-cta__btn">
          {HERO.primaryCta}
        </Link>
      </aside>
    </div>
